function mostrarCursoInfo(curso) {
    const cursoInfo = {
        ecgm: {
            title: 'Engenharia de Computação Gráfica e Multimédia',
            logo: 'assets/cursos/ecgm.png',
        ...
        ncgm: {
            title: 'Núcleo de Computação Gráfica e Multimédia',
            logo: 'assets/cursos/ncgm.png',
    ...
    const info = cursoInfo[curso];
    if (info) {
        document.getElementById('cursoModalLabel').textContent = info.title;
        document.getElementById('cursoModalBody').innerHTML = `
            <img src="${info.logo}" alt="Logo do curso" class="img-fluid mb-3" style="max-height: 150px;" id="cursoIconModal">
